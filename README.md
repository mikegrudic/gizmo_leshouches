...
*Comparison of an isothermal galaxy disk simulated with RAMSES AMR, SPH, and GIZMO's MFM and MFV methods at comparable resolution. Note the finer structure that is preserved by the Lagrangian methods in this highly supersonic flow.*
